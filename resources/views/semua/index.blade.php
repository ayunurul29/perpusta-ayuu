        ...
        <div style="overflow: auto">
            <table class="table table-bordered table-condensed">
                ...
                <tr>
                    ...
                    <td style="text-align:center;">{{ @$value->role->role}}</td>
                <td>
                <form style="text-align:center;" action="{{ route('semua_destroy',['semua'=>$value->id]) }}" method="POST">
         
                    <a class="btn btn-info" href="{{ route('semua_show',$value->id) }}">Show</a>
          
                    <a class="btn btn-primary" href="{{ route('semua_edit', ['semua'=>$value->id]) }}"?>Edit</a>
